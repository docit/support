<?php
namespace Docit\Support\Vendor;

use Docit\Support\Exceptions\InvalidStyleException;

/**
 * This is the ConsoleColor.
 *
...
class ConsoleColor
{
     ...
     * @param string       $text
     * @return string
     * @throws \Docit\Support\Exceptions\InvalidStyleException
        ...
        foreach ($style as $s) {
            if (isset($this->themes[ $s ])) {
                ...
                if ($this->isValidStyle($s)) {
                    ...
                    throw new \Docit\Support\Exceptions\InvalidStyleException($s);
                }
            }
        }
