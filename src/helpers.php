...
if (! function_exists('path_join')) {
    function path_join()
    {
        return forward_static_call_array([ 'Docit\Support\Path', 'join' ], func_get_args());
    }
}
...
if (! function_exists('path_is_absolute')) {
    ...
    {
        return forward_static_call_array([ 'Docit\Support\Path', 'isAbsolute' ], func_get_args());
    }
}
...
if (! function_exists('path_is_relative')) {
    ...
    {
        return forward_static_call_array([ 'Docit\Support\Path', 'isRelative' ], func_get_args());
    }
}
...
if (! function_exists('path_get_directory')) {
    ...
    {
        return forward_static_call_array([ 'Docit\Support\Path', 'getDirectory' ], func_get_args());
    }
}
...
if (! function_exists('path_get_extension')) {
    ...
    {
        return forward_static_call_array([ 'Docit\Support\Path', 'getExtension' ], func_get_args());
    }
}
...
if (! function_exists('path_get_filename')) {
    ...
    {
        return forward_static_call_array([ 'Docit\Support\Path', 'getFilename' ], func_get_args());
    }
}
